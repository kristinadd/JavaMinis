...
public class ComparePersonByName implements Comparator<Person> {
  ...
  // which is automatically provided by Java if no constructors are explicitly defined. Then, you can use that instance as a comparator.
  ...
  // Instead of manually implementing string comparison logic, you can rely on the compareTo method of the String class for accurate and optimized comparisons.
